let fs = require('fs')                    //CREATOR = aulia :) , DEVBOT
let chalk = require('chalk')
global.owner = [
  ['6285839814393'],
  ['6285839814393'],
  ['6285839814393', 'Owner Zuls', true]  
  
] 
global.ownername = [['ZUL SLEBEW 🥶🥶']]
global.namabot = [['AzzBot-MD']]
global.ownerinsta = [['________']]
global.mods = [] 
global.prems = [] 
